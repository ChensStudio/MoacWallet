...
import '../../lib/moac/observeTransactions.js';
import '../../lib/moac/observeWallets.js';
import '../../lib/moac/tokenInterface.js';
import '../../lib/moac/walletConnector.js';
import '../../lib/moac/walletInterface.js';
import '../../lib/appStart.js';
import '../../lib/collections.js';
import '../elements/balance.js';
import './header.html';
import './main.html';
...
Template['layout_header'].helpers({
    ...
    */
    'goToSend': function() {
        ...
        var address = chain3.toChecksumAddress(FlowRouter.getParam('address'));  
        var accounts = McAccounts.find({}).fetch();
