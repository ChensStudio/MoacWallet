...
Template['elements_account'].helpers({
    ...
    */
    'creating': function(){
        ...
        var belowReorgThreshold = (blocksForConfirmation >= McBlocks.latest.number - (this.creationBlock - 1));
        var blockNumberCheck = McBlocks.latest.number - (this.creationBlock - 1) >= 0;
    ...
    */
    'unConfirmed': function() {
        ...
        var currentBlockNumber = McBlocks.latest.number,
