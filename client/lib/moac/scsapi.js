...
scsApi.requestc = function(bodyJSON, rpcaddr, rpcport, sender, subChainAddr) {
    scsApi.init();
    scsApi.url = 'http://' + rpcaddr + ':' + rpcport;
...
scsApi.getNonce = function(rpcaddr, rpcport, sender, subChainAddr) {
    if (!subChainAddr) {
    ...
    return scsApi.request(bodyJSON, rpcaddr, rpcport, sender, subChainAddr);
};